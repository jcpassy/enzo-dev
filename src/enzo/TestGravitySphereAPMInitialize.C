                                   ...
                                   HierarchyEntry &TopGrid, TopGridData &MetaData)
{
  ...
  if (TopGrid.GridData->TestGravitySphereInitializeGrid(TestGravitySphereInteriorDensity,
                                                        TestGravitySphereExteriorDensity,
                                                        TestGravitySphereRadius,
                                                        TestGravitySphereType,
                                                        TestGravitySphereUseBaryons,
  ...
  if (TestGravitySphereRefineAtStart) {
    ...
    for (level = 0; level < MaximumRefinementLevel; level++) {
      ...
      while (Temp != NULL) {
        if (Temp->GridData->TestGravitySphereInitializeGrid(TestGravitySphereInteriorDensity,
                                                            TestGravitySphereExteriorDensity,
                                                            TestGravitySphereRadius,
                                                            TestGravitySphereType,
                                                            TestGravitySphereUseBaryons,
